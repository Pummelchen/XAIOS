...
hosted-test: engine-cli
	...
	$(HOST_CC) $(HOST_CFLAGS) \
	  ...
	  engine/src/xai_fs.c engine/src/xai_fs_writer.c engine/src/xai_fs_writer_util.c \
	...
	$(HOST_CC) $(HOST_CFLAGS) \
	  -Ikernel/include kernel/fs/xaiboot_fs.c kernel/fs/xbfs_state.c kernel/fs/xbfs_node_codec.c kernel/fs/xbfs_util.c kernel/fs/xbfs_record.c kernel/fs/xbfs_metadata.c kernel/dev/block_device.c \
	...
	$(HOST_CC) $(HOST_CFLAGS) \
	  ...
	  engine/src/xai_fs_writer.c engine/src/xai_fs_writer_util.c engine/src/model_file.c \
	  engine/src/sha256.c \
	  userspace/sshd/ssh_crypto.c userspace/sshd/tweetnacl_subset.c \
