...
hosted-test: engine-cli
	...
	$(HOST_CC) $(HOST_CFLAGS) \
	  -Ikernel/include kernel/fs/xaiboot_fs.c kernel/fs/xbfs_state.c kernel/fs/xbfs_node_codec.c kernel/fs/xbfs_util.c kernel/fs/xbfs_record.c kernel/dev/block_device.c \
