...
Six defects, and none of them is a boot failure or a data-loss path. Each is
...
| `B-49` | A data sector number truncates above 32 MiB | Not reachable by any volume that currently boots. One word to widen, and a behaviour change to large v6 volumes that deserves its own gate. |
