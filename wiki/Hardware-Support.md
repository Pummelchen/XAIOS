...
| VMware Fusion ARM64 | Experimental functional guest path: Fusion 26 evidence covers PCI-discovered E1000E DHCP, AHCI MutableFS persistence and public-key SSH. Bootstrap-only CPU policy, VMXNET3, live DNSSEC interoperability, IPv6/SFTP/outbound-client gates and Fusion multi-vCPU qualification remain open. |
