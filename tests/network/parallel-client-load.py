...
# The helper module lives beside this driver. The directory is added
# explicitly rather than assumed from how the script was started: the Docker
# image runs a copy of this file out of /usr/local/bin, and repository checks
# compile the original from tests/network.
sys.path.insert(0, str(Path(__file__).resolve().parent))
from parallel_client_load_lib import (  # noqa: E402
    COMMAND_TIMEOUT,
    key_options,
    password_command,
    payload_bytes,
