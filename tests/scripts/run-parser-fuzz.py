...
def main() -> int:
    ...
    targets = {
        ...
        "dns": [
            ...
            "kernel/net/dns.c",
            "kernel/net/dns_resolver.c", "kernel/net/dns_selftest.c", "kernel/net/dnssec.c", "kernel/net/ipv4.c",
            "userspace/sshd/ssh_crypto.c",
            "userspace/sshd/ssh_crypto_symmetric.c", "userspace/sshd/ssh_crypto_curve25519.c", "userspace/sshd/tweetnacl_subset.c",
