...
compile "$ROOT_DIR/kernel/arch/riscv64/mmu_selftest.c"
compile "$ROOT_DIR/kernel/arch/riscv64/mmu_map.c"
compile "$ROOT_DIR/kernel/arch/riscv64/mmu_user.c"
compile "$ROOT_DIR/kernel/arch/riscv64/mmu_shootdown.c"
compile "$ROOT_DIR/kernel/arch/riscv64/smp.c"
compile "$ROOT_DIR/kernel/arch/riscv64/smp_bringup.c"
compile "$ROOT_DIR/kernel/arch/riscv64/smp_registry.c"
