...
compile_kernel "$ROOT_DIR/kernel/core/klog_console.c" "$KERNEL_BUILD_DIR/klog_console.o"
compile_kernel "$ROOT_DIR/kernel/core/klog_format.c" "$KERNEL_BUILD_DIR/klog_format.o"
...
compile_kernel "$ROOT_DIR/kernel/dev/input_queue.c" "$KERNEL_BUILD_DIR/input_queue.o"
compile_kernel "$ROOT_DIR/kernel/dev/input_hid.c" "$KERNEL_BUILD_DIR/input_hid.o"
...
compile_kernel "$ROOT_DIR/kernel/core/panic_render.c" "$KERNEL_BUILD_DIR/panic_render.o"
...
if [ "$TARGET_ARCH" = aarch64 ]; then
  ...
  compile_kernel "$ROOT_DIR/kernel/dev/pci_ecam_bars.c" "$KERNEL_BUILD_DIR/pci_ecam_bars.o"
  compile_kernel "$ROOT_DIR/kernel/dev/pci_ecam_msix.c" "$KERNEL_BUILD_DIR/pci_ecam_msix.o"
...
compile_kernel "$ROOT_DIR/kernel/arch/aarch64/smp_platform.c" "$KERNEL_BUILD_DIR/smp_platform.o"
compile_kernel "$ROOT_DIR/kernel/arch/aarch64/smp_registry.c" "$KERNEL_BUILD_DIR/smp_registry.o"
...
compile_kernel "$ROOT_DIR/kernel/arch/x86_64/early_lapic.c" "$KERNEL_BUILD_DIR/early_lapic.o"
...
compile_kernel "$ROOT_DIR/kernel/arch/x86_64/early_idt.c" "$KERNEL_BUILD_DIR/early_idt.o"
...
compile_kernel "$ROOT_DIR/kernel/fs/vfs_namespace.c" "$KERNEL_BUILD_DIR/vfs_namespace.o"
compile_kernel "$ROOT_DIR/kernel/fs/vfs_handle.c" "$KERNEL_BUILD_DIR/vfs_handle.o"
...
compile_kernel "$ROOT_DIR/kernel/fs/xai_fs_admin_support.c" "$KERNEL_BUILD_DIR/xai_fs_admin_support.o"
...
compile_kernel "$ROOT_DIR/kernel/runtime/security_update.c" "$KERNEL_BUILD_DIR/security_update.o"
compile_kernel "$ROOT_DIR/kernel/runtime/security_credential.c" "$KERNEL_BUILD_DIR/security_credential.o"
...
compile_kernel "$ROOT_DIR/kernel/runtime/operations_format.c" "$KERNEL_BUILD_DIR/operations_format.o"
compile_kernel "$ROOT_DIR/kernel/runtime/operations_commands.c" "$KERNEL_BUILD_DIR/operations_commands.o"
...
compile_kernel "$ROOT_DIR/kernel/runtime/ai_cell_descriptor.c" "$KERNEL_BUILD_DIR/ai_cell_descriptor.o"
compile_kernel "$ROOT_DIR/kernel/runtime/ai_cell_self_test.c" "$KERNEL_BUILD_DIR/ai_cell_self_test.o"
...
compile_kernel "$ROOT_DIR/kernel/runtime/update_delivery.c" "$KERNEL_BUILD_DIR/update_delivery.o"
...
compile_kernel "$ROOT_DIR/kernel/storage/gpt_write.c" "$KERNEL_BUILD_DIR/gpt_write.o"
...
compile_kernel "$ROOT_DIR/kernel/runtime/source_index_scanner.c" "$KERNEL_BUILD_DIR/source_index_scanner.o"
compile_kernel "$ROOT_DIR/kernel/runtime/source_index_self_test.c" "$KERNEL_BUILD_DIR/source_index_self_test.o"
...
compile_kernel "$ROOT_DIR/kernel/runtime/git_workspace_hash.c" "$KERNEL_BUILD_DIR/git_workspace_hash.o"
compile_kernel "$ROOT_DIR/kernel/runtime/git_workspace_selftest.c" "$KERNEL_BUILD_DIR/git_workspace_selftest.o"
...
compile_kernel "$ROOT_DIR/kernel/net/ipv6_ext.c" "$KERNEL_BUILD_DIR/ipv6_ext.o"
...
compile_kernel "$ROOT_DIR/kernel/net/dhcpv6_codec.c" "$KERNEL_BUILD_DIR/dhcpv6_codec.o"
...
compile_kernel "$ROOT_DIR/engine/src/xai_fs_codec.c" "$KERNEL_BUILD_DIR/engine_xai_fs_codec.o"
compile_kernel "$ROOT_DIR/engine/src/xai_fs_read.c" "$KERNEL_BUILD_DIR/engine_xai_fs_read.o"
