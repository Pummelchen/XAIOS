...
USER_APPS="xaios-shell xaiosctl nano pong hello sysinfo systest smptest smpstress perfbench nettest netmqtest lstm-xor sshtest mltest posix-shell agenttest xaios-setup xtop clustertest"
