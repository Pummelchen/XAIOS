...
USER_APPS="xaios-shell xaiosctl xapt nano xtop pong hello sysinfo systest smptest smpstress perfbench nettest netmqtest lstm-xor sshtest mltest posix-shell agenttest clustertest xaios-setup"
