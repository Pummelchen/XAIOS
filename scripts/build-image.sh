...
USER_NET_OBJ="$INIT_BUILD_DIR/xaios-user-net.o"
USER_SESSION_OBJ="$INIT_BUILD_DIR/xaios-user-session.o"
USER_SCREEN_OBJ="$INIT_BUILD_DIR/xaios-screen.o"
USER_SCREEN_INPUT_OBJ="$INIT_BUILD_DIR/xaios-screen-input.o"
