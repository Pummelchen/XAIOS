...
/* CN=ISRG Root X1,O=Internet Security Research Group,C=US (ISRG_Root_X1.pem) */
...
/* CN=ISRG Root X2,O=Internet Security Research Group,C=US (ISRG_Root_X2.pem) */
...
const br_x509_trust_anchor XAPT_TRUST_ANCHORS[] = {
    { { (unsigned char *)TA0_DN, sizeof TA0_DN },
      BR_X509_TA_CA,
      { BR_KEYTYPE_RSA,
      { .rsa = { (unsigned char *)TA0_N, sizeof TA0_N,
                 (unsigned char *)TA0_E, sizeof TA0_E } } } },
    { { (unsigned char *)TA1_DN, sizeof TA1_DN },
      BR_X509_TA_CA,
      { BR_KEYTYPE_EC,
      { .ec = { 24, (unsigned char *)TA1_Q,
                sizeof TA1_Q } } } },
};
